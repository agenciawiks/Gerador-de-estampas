    ...
    <div className="modal-backdrop" onClick={onCancel}>
      <div className="modal-box" onClick={e => e.stopPropagation()}>
        ...
        <div className="flex gap-2 justify-end mt-2">
          ...
          <button
            onClick={onConfirm}
            className={`px-4 py-2 text-xs font-bold rounded-lg transition-colors ${danger
          ...
          <>
            ...
            <div className="px-4 py-3 border-b border-slate-200 dark:border-slate-800">
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 py-2.5 rounded-xl border-2 border-dashed text-xs font-bold uppercase transition-all ${isDragOver
              ...
              {abaAtual === 'fundos' && itensFiltrados.map(item => {
                ...
                return (
                  <div
                    ...
                    className={`p-2 rounded-xl border-2 transition-all flex items-center gap-2.5 relative overflow-hidden group cursor-pointer ${fundoPreview?.id === item.id
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center gap-1 shrink-0">
                      <button
                        ...
                        className={`p-1.5 rounded-lg transition-colors cursor-pointer ${selected ? 'bg-green-100 dark:bg-green-900/60 text-green-600 dark:text-green-400' : 'bg-slate-100 dark:bg-slate-800 text-slate-400 hover:bg-green-50 hover:text-green-500'
                          }`}
              ...
              {abaAtual === 'estampas' && itensFiltrados.map(item => {
                ...
                return (
                  <div
                    ...
                    className={`p-2 rounded-xl border-2 transition-all flex items-center gap-2.5 relative group cursor-pointer ${selected
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center gap-1 shrink-0">
                      <button
                        ...
                        className={`p-1.5 rounded-lg transition-colors cursor-pointer ${selected ? 'bg-yellow-100 dark:bg-yellow-900/60 text-yellow-600 dark:text-yellow-400' : 'bg-slate-100 dark:bg-slate-800 text-slate-400 hover:bg-yellow-50 hover:text-yellow-500'
                          }`}
            ...
            <div className="relative z-10 h-11 border-b border-slate-200 dark:border-slate-800 flex items-center px-5 gap-3 bg-white dark:bg-slate-900 shadow-sm shrink-0">
              ...
              <div className="ml-auto shrink-0">
                <button
                  ...
                  className={`flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-[10px] font-bold transition-all ${showKbdHints
                  ...
                  {BRASIL_COLORS.map(c => (
                    <div key={c.hex} className="swatch-wrap">
                      <button
                        ...
                        title={c.label}
                        className={`w-full aspect-square rounded-full border-2 transition-all hover:scale-110 shadow-sm ${corHex === c.hex && !usarCorOrig
                ...
                <div className="flex gap-1">
                  {[50, 100, 150, 200].map(val => (
                    <button
                      ...
                      className={`flex-1 text-[10px] font-bold py-1 rounded transition-all ${escala === val
